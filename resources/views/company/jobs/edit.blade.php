            ...
            <div class="-m-2 lg:min-w-full md:w-2/3 rounded-lg bg-white">
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative mt-4">
                  ...
                  <input type="text" id="title" name="title" minlength="10" maxlength="100" required value="{{ $jobOffer->title }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                  @error('title')
              ...
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
                  ...
                  <input type="number" min="0" id="annual_salary" name="annual_salary" required value="{{ $jobOffer->annual_salary }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
              </div>
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
                  <label for="hourly_pay" class="leading-7 text-sm font-bold text-gray-600">Hourly pay</label>
                  <input type="number" min="0" id="hourly_pay" name="hourly_pay" required value="{{ $jobOffer->hourly_pay }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                  @error('hourly_pay')
                    <div class="alert alert-danger text-red-500">{{ $message }}</div>
                  @enderror
                </div>
